...
/// Reference to HCLinearChartView instance where HCChartDrawer needs to draw the chart.
    HCLinearChartView* hcLinearChartView;
    
/// HCLinearChartView rect size, necessary for accurate drawing chart componente
    CGRect chartRect;
...
/// This property defines if dots in chart are represented as simple dots or with circles. This property is indirectly defined by user, by chartLineWithCircles parameter in HCLinearChartView.
...
/// @param linearChartView Reference to the HCLinearChartView instance. HCChartDrawer needs to draw chart inside this instance
/// @param rect Rect for HCLinearChartView
-(void)drawChart:(HCLinearChartView*)linearChartView inRect:(CGRect)rect;
