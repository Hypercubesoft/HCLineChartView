...
{
    hcLinearChartView = linearChartView;
    chartRect = rect;
    [self drawLineChart];
...
-(void)handleInvalidValues
{
    ...
    CGSize textSize = [self sizeOfText:chartWithInvalidValuesString withFontSize:hcLinearChartView.fontSizeForTitle];
    ...
    UIFont *font = [UIFont systemFontOfSize:hcLinearChartView.fontSizeForTitle];
