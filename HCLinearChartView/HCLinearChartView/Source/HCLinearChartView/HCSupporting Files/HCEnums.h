...
/// This property defines calendar type for the chart. It is used inside HCLinearChart library for displaying appropriate date / time values on X axis if values on X axis are represented as NSDate instances.
